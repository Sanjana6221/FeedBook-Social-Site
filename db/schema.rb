...
ActiveRecord::Schema.define(version: 20170817113042) do
  ...
  create_table "facebook_oauth_settings", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
